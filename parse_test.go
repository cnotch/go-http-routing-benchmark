...
func init() {
	...
	calcMem("ApiRouter", func() {
		parseApiRouter = loadApiRouter(parseAPI)
	})
	calcMem("Bear", func() {
...
func BenchmarkApiRouter_ParseStatic(b *testing.B) {
	req, _ := http.NewRequest("GET", "/1/users", nil)
	benchRequest(b, parseApiRouter, req)
}
...
func BenchmarkApiRouter_ParseParam(b *testing.B) {
	req, _ := http.NewRequest("GET", "/1/classes/go", nil)
	benchRequest(b, parseApiRouter, req)
}
...
func BenchmarkApiRouter_Parse2Params(b *testing.B) {
	req, _ := http.NewRequest("GET", "/1/classes/go/123456789", nil)
	benchRequest(b, parseApiRouter, req)
}
...
func BenchmarkApiRouter_ParseAll(b *testing.B) {
	benchRoutes(b, parseApiRouter, parseAPI)
}
